...
namespace WebSite.Controllers
{
    ...
    public partial class T4MVC_AccountController : WebSite.Controllers.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Contracts.ViewModels.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(Contracts.ViewModels.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Contracts.ViewModels.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(Contracts.ViewModels.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
