...
public static class MVC
{
    ...
    public static WebSite.Controllers.GamesController Games = new WebSite.Controllers.T4MVC_GamesController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string Chess_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Chess.min.js") ? Url("Chess.min.js") : Url("Chess.js");
                      
        public static readonly string ChessTest_ts = Url("ChessTest.ts");
        public static readonly string ChessTest_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ChessTest.min.js") ? Url("ChessTest.min.js") : Url("ChessTest.js");
        ...
        public static readonly string jquery_signalR_1_0_1_min_js = Url("jquery.signalR-1.0.1.min.js");
        ...
        public static readonly string NinjaJS_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/NinjaJS.min.js") ? Url("NinjaJS.min.js") : Url("NinjaJS.js");
    ...
    public static class Content {
        ...
        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
        public static readonly string ChessBoard_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ChessBoard.min.css") ? Url("ChessBoard.min.css") : Url("ChessBoard.css");
